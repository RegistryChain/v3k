...
type MobileEntityInputProps = {
  state: TransitionState
  toggle: (value: boolean) => void
  searchInputRef: RefObject<HTMLInputElement>
  SearchResultsElement: JSX.Element
  EntityInputElement: JSX.Element
}

const MobileEntityInput = ({
  state,
  toggle,
  searchInputRef,
  SearchResultsElement,
  EntityInputElement,
}: MobileEntityInputProps) => {
...
export const EntityInput = ({ size = 'extraLarge', field, value, setValue }: any) => {
